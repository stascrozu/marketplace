...
import com.example.marketplace.domain.ApiError;
import com.example.marketplace.domain.ProductNotFoundException;
...
@ControllerAdvice
@RestController
public class CustomRestExceptionController extends ResponseEntityExceptionHandler {
